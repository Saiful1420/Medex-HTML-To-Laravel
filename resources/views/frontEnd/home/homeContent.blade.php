...
@section('mainContent')
<section class="hero-wrap js-fullheight" style="background-image: url('/fontEnd/images/bg_2.jpg');" data-stellar-background-ratio="0.5">
		...
		<div class="container">
			<div class="row d-flex">
				<div class="col-md-6 col-lg-5 d-flex">
					<div class="img w-100 d-flex align-self-stretch align-items-center" style="background-image:url(/fontEnd/images/about.jpg);">
					</div>
				</div>
	...
	<section class="ftco-intro img" style="background-image: url(/fontEnd/images/bg_3.jpg);">
		<div class="overlay"></div>
		<div class="container">
				...
				<div class="col-md-9">
					<div class="tab-content pt-4 pt-md-0 pl-md-3">
						<div class="tab-pane container p-0 active" id="services-1">
							<div class="row">
								<div class="col-md-5 img" style="background-image: url(/fontEnd/images/dept-1.jpg);"></div>
						...
						<div class="tab-pane container p-0 fade" id="services-2">
							<div class="row">
								<div class="col-md-5 img" style="background-image: url(/fontEnd/images/dept-2.jpg);"></div>
								<div class="col-md-7 text pl-md-4">
						...
						<div class="tab-pane container p-0 fade" id="services-3">
							<div class="row">
								<div class="col-md-5 img" style="background-image: url(/fontEnd/images/dept-3.jpg);"></div>
								<div class="col-md-7 text pl-md-4">
						...
						<div class="tab-pane container p-0 fade" id="services-4">
							<div class="row">
								<div class="col-md-5 img" style="background-image: url(/fontEnd/images/dept-4.jpg);"></div>
								<div class="col-md-7 text pl-md-4">
						...
						<div class="tab-pane container p-0 fade" id="services-5">
							<div class="row">
								<div class="col-md-5 img" style="background-image: url(/fontEnd/images/dept-5.jpg);"></div>
								<div class="col-md-7 text pl-md-4">
						...
						<div class="tab-pane container p-0 fade" id="services-6">
							<div class="row">
								<div class="col-md-5 img" style="background-image: url(/fontEnd/images/dept-6.jpg);"></div>
								<div class="col-md-7 text pl-md-4">
						...
						<div class="tab-pane container p-0 fade" id="services-7">
							<div class="row">
								<div class="col-md-5 img" style="background-image: url(/fontEnd/images/dept-7.jpg);"></div>
								<div class="col-md-7 text pl-md-4">
		...
		<div class="container-fluid px-5">
			...
			<div class="row">
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(/fontEnd/images/doc-1.jpg);"></div>
						</div>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(/fontEnd/images/doc-2.jpg);"></div>
						</div>
						<div class="text text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(/fontEnd/images/doc-3.jpg);"></div>
						</div>
						<div class="text text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(/fontEnd/images/doc-4.jpg);"></div>
						</div>
						<div class="text text-center">
	...
	<section class="ftco-facts img ftco-counter" style="background-image: url(/fontEnd/images/bg_3.jpg);">
		<div class="overlay"></div>
		<div class="container">
			<div class="row">
	...
	<section class="ftco-section testimony-section img" style="background-image: url(/fontEnd/images/bg_4.jpg);">
		<div class="overlay"></div>
		<div class="container">
					...
					<div class="carousel-testimony owl-carousel ftco-owl">
						<div class="item">
							<div class="testimony-wrap py-4 pb-5 d-flex justify-content-between">
								<div class="user-img" style="background-image: url(/fontEnd/images/person_1.jpg)">
						...
						<div class="item">
							<div class="testimony-wrap py-4 pb-5 d-flex justify-content-between">
								<div class="user-img" style="background-image: url(/fontEnd/images/person_2.jpg)">
									<span class="quote d-flex align-items-center justify-content-center">
										<i class="fa fa-quote-left"></i>
									</span>
								</div>
						...
						<div class="item">
							<div class="testimony-wrap py-4 pb-5 d-flex justify-content-between">
								<div class="user-img" style="background-image: url(/fontEnd/images/person_3.jpg)">
									<span class="quote d-flex align-items-center justify-content-center">
										<i class="fa fa-quote-left"></i>
									</span>
								</div>
