  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 ftco-animate">
        ...
        <p>
          <img src="/fontEnd/images/image_3.jpg" alt="" class="img-fluid">
        </p>
        ...
        <p>
          <img src="/fontEnd/images/image_4.jpg" alt="" class="img-fluid">
        </p>
        ...
        <div class="about-author d-flex p-4 bg-light">
          <div class="bio mr-5">
            <img src="/fontEnd/images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4">
          </div>
          <div class="desc">
        ...
        <div class="pt-5 mt-5">
          ...
          <ul class="comment-list">
            <li class="comment">
              <div class="vcard bio">
                <img src="/fontEnd/images/person_1.jpg" alt="Image placeholder">
              </div>
      ...
      <div class="sidebar-box ftco-animate">
        ...
        <div class="block-21 mb-4 d-flex">
          <a class="blog-img mr-4" style="background-image: url(/fontEnd/images/image_1.jpg);"></a>
          <div class="text">
        ...
        <div class="block-21 mb-4 d-flex">
          <a class="blog-img mr-4" style="background-image: url(/fontEnd/images/image_2.jpg);"></a>
          <div class="text">
            <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
            <div class="meta">
              <div><a href="#"><span class="icon-calendar"></span> Aug. 12, 2020</a></div>
        ...
        <div class="block-21 mb-4 d-flex">
          <a class="blog-img mr-4" style="background-image: url(/fontEnd/images/image_3.jpg);"></a>
          <div class="text">
            <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
            <div class="meta">
              <div><a href="#"><span class="icon-calendar"></span> Aug. 12, 2020</a></div>
